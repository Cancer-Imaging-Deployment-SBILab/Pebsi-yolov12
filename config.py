...
REFRESH_TOKEN_COOKIE_SECURE = os.getenv("REFRESH_TOKEN_COOKIE_SECURE", "false").lower() == "true"  # Set to true in production with HTTPS
REFRESH_TOKEN_COOKIE_HTTPONLY = True  # Always true - prevents JS access
REFRESH_TOKEN_COOKIE_SAMESITE = os.getenv("REFRESH_TOKEN_COOKIE_SAMESITE", "lax")  # 'lax', 'strict', or 'none'
...
INTERNAL_SERVICE_API_KEY = os.getenv("INTERNAL_SERVICE_API_KEY", "default-internal-service-key-change-in-production")
